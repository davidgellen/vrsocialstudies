...
public class SoundManager : MonoBehaviour
{
		...
		public SoundManager()
		{
			audioSource = ScManager.audioSource;
		}
		...
		*/
		...
		//Dynamic audio recording end
		 AudioClip EndRecording (AudioSource audS, string deviceName)
		 {
		...
		*/
        ...
        {
			audioSource.clip = EndRecording(audioSource, Microphone.devices[0]);
